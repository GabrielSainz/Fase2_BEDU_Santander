...
# En R para calcular valores de las funciones de probabilidad, distribución o 
# cuantiles de la distribución binomial (discreta), usamos las funciones dbinom,
# pbinom y qbinom respectivamente. Para generar muestras aleatorias de esta 
# distribución utilizamos la función rbinom.

# Consideremos un experimento binomial con n = 30 pruebas idénticas e 
# independientes, en donde la probabilidad de éxito en cada prueba es p = 0.2 
# (parámetros n = 30 y p = 0.2)

# Función de probabilidad
# Para obtener P(X = 20), es decir, la probabilidad de observar 20 éxitos 
# exactamente, en R ejecutamos

dbinom(x = 20, size = 30, prob = 0.2)

# Función de distribución
# Para obtener P(X <= 20), es decir, la probabilidad de observar a lo más 20 
# éxitos, en R corremos

pbinom(q = 20, size = 30, prob = 0.2)

# Para encontrar el valor más pequeño b tal que P(X <= b) >= 0.35, es decir, el 
...
# Muestras aleatorias
# Para obtener una muestra aleatoria de tamaño n = 1000, de la distribución 
# binomial con parámetros como especificamos, hacemos
...
# Distribución normal
# En R para calcular valores de las funciones de densidad, distribución o 
# cuantiles de la distribución normal (continua), usamos las funciones dnorm,
...
# media 175 y desviación estándar 6 (parámetros mu = 175 y sigma = 6)
...
# Observemos la región que corresponde a esta probabilidad en la siguiente 
# gráfica en color rojo
...
# Cuantiles
# Para encontrar el número b, tal que P(X <= b) = 0.75, es decir, el cuantil 
...
# Muestras aleatorias
# Para generar una muestra aleatoria de tamaño n = 1000 de la v.a. X corremos 
...
# En R para calcular valores de las funciones de densidad, distribución o 
# cuantiles de la distribución t de Student (continua), usamos las funciones 
...
# Student con 7 grados de libertad (gl) (parámetro gl = 7)
...
# Para encontrar el número d tal que P(T <= d) = 0.025, es decir, el cuantil de
# orden 0.025, corremos la siguiente instrucción
...
# Muestras aleatorias
# Para generar una muestra aleatoria de tamaño n = 1000 de la v.a. T corremos 
# la siguiente instrucción
...
# Ahora obtenemos una muestra aleatoria de tamaño n = 4 de la distribución 
...
# Ahora obtenemos 1000 muestras de tamaño 7 y las 1000 medias correspondientes 
# a las muestras
...
sd(media1000.400); (1/2)/sqrt(400) # DE de las 1000 medias y DE de la población de la cual vienen la
...
# Obtenemos 1200 muestras aleatorias de tamaño 350 y las 1200 medias 
...
# en donde el 0 (fracaso) puede ocurrir con probabilidad 0.45 y el 1 (éxito) 
...
# Obtenemos 1150 muestras aleatorias de tamaño n1 = 54 de una distribución 
# exponencial con parámetro lambda1 = 3.2 y otras 1150 muestras aleatorias de 
# tamaño n2 = 41 de una distribución exponencial con parámetro lambda2 = 1.5.
...
# Obtenemos 1100 muestras de tamaño n1 = 48 de una v.a. Bernoulli con p1 = 0.65 
# y otras 1100 muestras de tamaño n2 = 35 de una v.a. Bernoulli con p2 = 0.53
...
# estamos interesados en contrastar las hipótesis H0: mu = 0.1 vs H1: mu > 0.1 
# (contraste de cola superior)
...
# estamos interesados en contrastar las hipótesis H0: mu1-mu2 = 0 vs 
...
# Supongamos que estamos interesados en encontrar la región de rechazo (de dos
...
tail(as.data.frame(muestra))
# estamos interesados en contrastar las hipótesis H0: mu = 170 vs H1: mu > 170 
# (contraste de cola superior)
...
# estamos interesados en contrastar las hipótesis H0: mu1-mu2 = 0 vs H1: 
